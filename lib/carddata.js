"use strict";
// MARK: Imports
import { COL_NAME, PREFIXES } from "./constants.js";
...
function getMetalHidrPRE_FN({ lang, fmlaData, help }) {
  ...
  if (lang == "eu") {
    // Pas 1
    lines.push({
      left: [{ text: name1, color: COL_NAME.green }],
      right: help[0],
    });
...
function getHydroxidesNOX_FN({ lang, fmlaData, help }) {
  ...
  lines.push({
    ...
    right: "" // (FALTA REVISAR. CALDRIA DIR QUE EL NOX CORRESPON AL SUBÍNDEX DEL GRUP HIDROXIL)" .dev.
  });
