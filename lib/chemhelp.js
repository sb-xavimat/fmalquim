...
function getOxidesPRE_NF({ lang, fmlaData, help }) { } // TODO
function getOxidesNOX_FN({ lang, fmlaData, help }) { } // TODO
function getOxidesNOX_NF({ lang, fmlaData, help }) { } // TODO
...
function getOtherCovalents({ lang, system, mode, fmlaData, help }) {
  // Característiques:
  ...
  switch (`${system}-${mode}`) {
    case "PRE-FN": return getOtherCovalentsPRE_FN({ lang, fmlaData, help });
    case "PRE-NF": return getOtherCovalentsPRE_NF({ lang, fmlaData, help });
    case "NOX-FN": return getOtherCovalentsNOX_FN({ lang, fmlaData, help });
    case "NOX-NF": return getOtherCovalentsNOX_NF({ lang, fmlaData, help });
  }
}

function getOtherCovalentsPRE_FN({ lang, fmlaData, help }) {
  const { symb1, sub1, name1, symb2, sub2, name2 } = fmlaData;
  const lines = [];
  const prefix1 = sub1 ? PREFIXES[sub1] : "";
...
function getOtherCovalentsPRE_NF({ lang, fmlaData, help }) { } // TODO
function getOtherCovalentsNOX_FN({ lang, fmlaData, help }) { } // TODO
function getOtherCovalentsNOX_NF({ lang, fmlaData, help }) { } // TODO
